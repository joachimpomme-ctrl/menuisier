    ...
    <span ref={ref} className="inline-flex items-center gap-1">
      ...
      >
        <button
          ...
          className="inline-flex items-center justify-center w-4 h-4 rounded-full text-[9px] font-bold leading-none bg-zinc-700/60 text-zinc-400 hover:bg-amber-600/30 hover:text-amber-400 transition-colors cursor-help flex-shrink-0"
          aria-label="Aide"
          tabIndex={-1}
        >
          ?
        ...
        {open && (
          <div
            ref={tooltipRef}
            className={`absolute z-50 w-64 px-3 py-2.5 rounded-xl border border-zinc-700 bg-zinc-800 shadow-xl shadow-black/40 text-xs text-zinc-300 leading-relaxed ${
